...
if __name__ == '__main__':
    ...
    train_name = f'./dataset/training_data_ns_scibert_n2vec_{train_year}.pickle' #cheeck carefully before doing
    test_name  = f'./dataset/testing_data_ns_scibert_n2vec_{test_year}.pickle'
